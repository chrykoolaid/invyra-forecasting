...
- `GET /v1/evaluations/history/{history_id}`
...
The C11 `/v1/history` route set remains unchanged. History-linked evaluation evidence is therefore exposed under the evaluation namespace at `/v1/evaluations/history/{history_id}`.
...
- Existing history API surface remains unchanged.
